    ...
    return (
        <form className="form_search">
            <label htmlFor="search">
                <input className="input_search" type="text" required placeholder="Search twitter" id="search" />
                <div className="fancy-bg_search"></div>
                ...
                <button className="close-btn_search" type="reset">
